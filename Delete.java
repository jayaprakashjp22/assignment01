...
public class Delete {
	public static void main(String[] args) throws InterruptedException {
	 ...
	 driver.findElement(By.xpath("//input[@id='username']")).sendKeys("vinothkumar@testleaf.com");
		...
		driver.findElement(By.xpath("//input[@name='Opportunity-search-input']")).sendKeys("Salesforce Automation by Jayaprakash");
		Thread.sleep(5000);
		...
		Thread.sleep(1000);
		WebElement OpportunityFound = driver.findElement(By.xpath("//a[text()= Salesforce Automation by Jayaprakash']"));
        String text = OpportunityFound.getText();
		if(text.equals("Salesforce Automation by Jayaprakash")) {
